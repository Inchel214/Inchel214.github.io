(() => {
  const dict = {
    zh: {
      ...
      sec_projects: "项目",
      sec_projects_list: "项目列表",
      sec_contact: "联系我",
      contact_intro: "如果你对我做的事感兴趣，或者希望与我交流讨论合作，请通过以下方式联系我",
      label_email: "邮箱：",
      label_github: "GitHub：",
      sec_tags: "标签",
    ...
    en: {
      ...
      sec_projects_list: "Projects List",
      sec_contact: "Contact",
      contact_intro: "If you're interested in my work or would like to discuss or collaborate, please contact me via:",
      label_email: "Email: ",
      label_github: "GitHub: ",
      sec_tags: "Tags",
